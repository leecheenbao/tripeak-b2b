...
> 專案啟動日：**2026-06-01**；預計完成日：**2027-09-30**（共約 **16 個月**）。  
...
gantt
    ...
    section 專案管理（88.4）
    專案啟動與規劃              :done,    pm1,  2026-06-01, 2026-06-30
    敏捷週期管控與進度回顧        :active,  pm2,  2026-07-01, 2027-09-30

    section 需求與架構設計
    需求訪談與使用案例確認        :done,    req1, 2026-06-01, 2026-06-30
    系統架構與資料庫綱要設計      :done,    des1, 2026-07-01, 2026-07-30
    前後端 API 契約定義          :done,    des2, 2026-07-15, 2026-08-15

    section 後端 API（88.2）
    身分認證模組（JWT／密碼雜湊）  :         be1,  2026-08-01, 2026-09-30
    訂單、購物車與使用者 API      :         be2,  2026-09-01, 2026-11-30
    產品、分類、管理與報表 API    :         be3,  2026-10-01, 2026-12-30

    section 資料與外部整合（88.3）
    MongoDB 綱要、索引與種子腳本  :         db1,  2026-08-01, 2026-09-30
    LINE Webhook 整合            :         int1, 2026-11-01, 2027-01-31
    NLU／Ollama 整合（選用）      :         int2, 2026-12-01, 2027-02-28

    section 前端應用（88.1）
    共用元件、路由守衛與 Pinia    :         fe1,  2026-08-15, 2026-10-31
    經銷商端頁面（購物、結帳、訂單）:         fe2,  2026-10-01, 2027-01-31
    管理後台頁面（CRUD、報表）    :         fe3,  2026-12-01, 2027-03-31

    section 測試與部署（88.4）
    系統整合測試                 :         tst1, 2027-03-01, 2027-05-28
    效能優化與安全稽核            :         tst2, 2027-04-01, 2027-06-30
    使用者驗收測試（UAT）         :         tst3, 2027-06-01, 2027-07-30
    Docker Compose 部署與文件化  :         dep1, 2027-07-01, 2027-08-31
    系統上線與結案               :         dep2, 2027-09-01, 2027-09-30

    section 查核點（Milestones）
    CP-01 專案啟動              :milestone, cp01, 2026-06-30, 0d
    CP-02 架構設計完成           :milestone, cp02, 2026-07-30, 0d
    CP-03 API 契約定義           :milestone, cp03, 2026-08-15, 0d
    CP-04 後端核心 API 完成      :milestone, cp04, 2026-10-31, 0d
    CP-05 Q4 季報               :milestone, cp05, 2026-12-30, 0d
    CP-06 前端 MVP 完成          :milestone, cp06, 2027-01-31, 0d
    CP-07 Q1 季報               :milestone, cp07, 2027-03-31, 0d
    CP-08 安全稽核完成           :milestone, cp08, 2027-06-30, 0d
    CP-09 UAT 通過              :milestone, cp09, 2027-07-30, 0d
    CP-10 系統上線結案           :milestone, cp10, 2027-09-30, 0d
```
...
| --- | --- |
| **日期** | 2026-12-30 |
| **類型** | 時間型：第四季季末季報（Quarterly Review） |
...
- [ ] 風險清單更新：識別當前阻礙項（Blocker），制定 Q1 2027 因應策略
...
- [ ] 已知技術債清單建立，並排入 Q2 2027 Sprint Backlog
...
| --- | --- |
| **日期** | 2027-06-30 |
| **類型** | 時間型：第二季季報（Q2 2027）+ 開發流程階段：安全／效能（Security Audit） |

**查核項目**

- [ ] Q2 季報產出：整合測試覆蓋率、缺陷密度與修復進度
...
| --- | --- | --- | --- | --- |
| CP-01 | 2026-06-30 | 階段型（啟動） | 專案啟動與環境建置確認 | 88.4 |
| CP-02 | 2026-07-30 | 階段型（設計） | 系統架構與資料庫設計完成 | 88.2、88.3 |
| CP-03 | 2026-08-15 | 階段型（API 契約） | 前後端 API 契約定義凍結 | 88.2、88.1 |
| CP-04 | 2026-10-31 | 階段型（實作） | 後端核心 API 完成 | 88.2.1、88.2.2 |
| CP-05 | 2026-12-30 | **時間型（Q4 季報）** | 第四季進度季報與風險更新 | 全部 |
| CP-06 | 2027-01-31 | 階段型（整合） | 前端 MVP 與 LINE 整合完成 | 88.1、88.3.2 |
| CP-07 | 2027-03-31 | **時間型（Q1 季報）** | Q1 2027 季報與整合測試啟動 | 全部 |
| CP-08 | 2027-06-30 | **時間型（Q2 季報）** + 階段型 | 安全稽核與效能優化完成 | 88.2、88.4 |
| CP-09 | 2027-07-30 | 階段型（UAT） | 使用者驗收測試通過 | 88.4.3 |
| CP-10 | 2027-09-30 | 里程碑（上線） | 系統正式上線與專案結案 | 88.4.1、88.4.2 |
